		...
		<div class="navbar-inner">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="${linkTo[IndexController].index}">Biblioteca</a>
				</div>
							...
							<li class="dropdown"><a class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									...
									<c:if test="${user.level == 'MANAGER' }">
										<li><a href="${linkTo[UserController].userForm}">Novo Usuário</a></li>
										<li><a href="${linkTo[UserController].listUsers}">Listar Usuários</a></li>
									</c:if>
								</ul></li>
						</ul>
					</c:if>
